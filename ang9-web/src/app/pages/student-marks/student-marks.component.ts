...
export class StudentMarksComponent implements OnInit {
  ...
  getStudents3(examDetail: ExamDetail, marksStatus: string) {
    const promise = new Promise((resolve, reject) => {
      if (marksStatus == 'New_Web_Marks') {
        this.php.getStudentsToSubmitMarks(examDetail.Scheme, examDetail.Branch, examDetail.Semester,
          marksStatus, 'None', this.limit, this.offset).subscribe(
          (res: any) => {
        ...
        this.php.getStudentsToSubmitMarks('None', 'None', 'None',
          marksStatus, this.examId, this.limit, this.offset).subscribe(
          (res: any) => {
